...
public slots:
    /**
     * @brief startTimer Start the animation timer
     */
    void startTimer();
    /**
     * @brief startTimer Stop the animation timer
     */
    void stopTimer();
    /**
     * @brief toggleMove Start/Stop the timer
     */
    void toggleMove();

    //For debugging only
    void showAxes(bool show){m_drawAxes = show;}
