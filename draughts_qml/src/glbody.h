...
public:
     ...
     */
      ...
      */
     GLBody(const QString & name, const QVector3D offset);
    ...
    virtual void makeSurface(QVector<GLPoint> * pointContainer, QVector<GLuint> *indexContainer);
     ...
     /**
     * @brief invalidateSurface Clears point and index containers and restes surfaceIsValid flag.
     * Throws an Exception, if containers are not owned.
     */
