    ...
    :QObject(parent)
{
    ...
    //mask
    m_location_uMaskDiameterSquare = -1;
    m_maskDiameter = 100.0;
    m_location_uMaskCenter = -1;
    m_maskCenter = QVector2D(200.0,200.0);
...
bool GLESRenderer::initialize()
{
    ...
    //mask
    m_location_uMaskDiameterSquare = m_renderProgram->uniformLocation("u_maskDiameterSquare");
...
bool GLESRenderer::bind()
{
    ...
    //mask
    if(m_location_uMaskDiameterSquare != -1)
        m_renderProgram->setUniformValue(m_location_uMaskDiameterSquare, m_maskDiameter * m_maskDiameter); //set square of diameter!
