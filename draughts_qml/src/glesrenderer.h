...
public:
    ...
    /**
     * @brief setMaskDiameter Diameter of circular mask in fragment shader
     * @param diameter Diameter in viewport (pixel) units.
     */
    void setMaskDiameter(float diameter){m_maskDiameter = diameter;}
    /**
     * @brief setMaskCenter Set the center of the mask circle
     * @param center Center in viewport coordinates. (Pixels, y upwards)
     */
    void setMaskCenter(const QVector2D center){m_maskCenter = center;}
    /**
...
protected:
    ...
    bool m_OrthoMode;
    float m_maskDiameter; //diameter of mask circle used in fragment shader.
                          //Is squared before transfer to shader.
    QVector2D m_maskCenter; //Center of the mask circle
    ...
    int m_location_uMaskDiameterSquare;
