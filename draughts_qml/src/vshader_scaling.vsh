...
uniform highp mat4 u_scaleMatrix;
uniform highp mat3 u_scaleNormalMatrix;
...
void main(void)
{
    gl_Position = u_scaleMatrix * u_MvpMatrix * a_Vertex;
    if(u_LightingEnabled)
      eyeSpaceNormal = normalize(u_scaleNormalMatrix * u_NormalMatrix * a_Normal);
